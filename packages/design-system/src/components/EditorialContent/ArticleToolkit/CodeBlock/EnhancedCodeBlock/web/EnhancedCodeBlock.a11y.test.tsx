...
describe('EnhancedCodeBlock Accessibility', () => {
  it('has no accessibility violations with empty markup', async () => {
    await expectNoA11yViolations(<EnhancedCodeBlock markup="" />);
  });
  ...
  it('has no accessibility violations with standard markup', async () => {
    ...
    await expectNoA11yViolations(<EnhancedCodeBlock markup={markup} />);
  });
  ...
  it('has no accessibility violations in immersive variant', async () => {
    ...
    await expectNoA11yViolations(<EnhancedCodeBlock markup={markup} variant="immersive" />);
  });
