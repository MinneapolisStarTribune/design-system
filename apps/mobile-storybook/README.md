...
- **iOS**: Requires macOS and Xcode. The simulator is an app that opens when you run `storybook:ios`.
- **Android**: Install Android Studio and create a virtual device; the emulator starts when you run `storybook:android`.
