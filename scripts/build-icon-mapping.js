...
// Get all SVG files and icon names (filter empty/invalid so we never emit blank lines)
const svgFiles = fs
...
// Value type must be SVG component (from *.svg?react), never string. Matches src/types/svg.d.ts.
...
// Generate TypeScript file content for iconNames.ts (semicolon on last line for Prettier)
