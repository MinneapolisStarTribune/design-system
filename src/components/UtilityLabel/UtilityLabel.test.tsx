...
describe('UtilityLabel', () => {
  ...
  it('applies correct class for small size with regular weight', () => {
    ...
    expect(getByTestId('label')).toHaveClass('typography-utility-label-regular-small');
  });
  ...
  it('applies correct class for large size', () => {
    ...
    expect(getByTestId('label')).toHaveClass('typography-utility-label-regular-large');
  });
  ...
  it('defaults to regular weight when weight prop is not provided', () => {
    ...
    expect(getByTestId('label')).toHaveClass('typography-utility-label-regular-medium');
  });
  ...
  it('applies caps class when capitalize is true', () => {
    ...
    expect(getByTestId('label')).toHaveClass('typography-utility-label-regular-small-caps');
  });
