...
export const colors = {
  ...
  'control-brand-accent-hover-background': ['#0D0D0D'],
  'control-brand-accent-hover-border': ['linear-gradient(to right, #DBFA7D, #76D86E)'],
  'control-brand-accent-hover-text': ['#ffffff'],
  'control-brand-accent-text': ['#0D0D0D'],
  'control-brand-background': ['#48A0FF'],
  'control-brand-button-icon': ['#0D0D0D'],
  'control-brand-hover-background': ['#ADD5FF'],
